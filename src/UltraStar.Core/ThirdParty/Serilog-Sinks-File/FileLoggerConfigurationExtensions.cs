...
using System.Text;
using UltraStar.Core.ThirdParty.Serilog.Configuration;
using UltraStar.Core.ThirdParty.Serilog.Core;
using UltraStar.Core.ThirdParty.Serilog.Debugging;
using UltraStar.Core.ThirdParty.Serilog.Events;
using UltraStar.Core.ThirdParty.Serilog.Formatting;
using UltraStar.Core.ThirdParty.Serilog.Formatting.Display;
using UltraStar.Core.ThirdParty.Serilog.Formatting.Json;
using UltraStar.Core.ThirdParty.Serilog.Sinks.File;

// ReSharper disable RedundantArgumentDefaultValue, MethodOverloadWithOptionalParameter

namespace UltraStar.Core.ThirdParty.Serilog
{
