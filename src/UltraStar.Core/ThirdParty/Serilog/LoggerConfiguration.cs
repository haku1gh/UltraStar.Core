...
using System.Linq;
using UltraStar.Core.ThirdParty.Serilog.Capturing;
using UltraStar.Core.ThirdParty.Serilog.Configuration;
using UltraStar.Core.ThirdParty.Serilog.Core;
using UltraStar.Core.ThirdParty.Serilog.Core.Enrichers;
using UltraStar.Core.ThirdParty.Serilog.Core.Sinks;
