...
{
    /// <summary>
    /// BASS device initialization flags.
    /// </summary>
    [Flags]
    internal enum BassDeviceInitFlags
    {
        /// <summary>
        ...
        /// Note: If this is not specified when initilizing BASS, then this flag is ignored when loading/creating a sample/stream/music.
        /// </summary>
        Device3D = 0x4,
